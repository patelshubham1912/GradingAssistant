 ...
 */
public class viewAssignmentFragmentBackgroundTask extends AsyncTask<String,Void,String> {
    ...
    public viewAssignmentFragmentBackgroundTask(Context ctx,AsyncResponse delegate) {
        this.ctx=ctx;
    ...
    protected String doInBackground(String... params) {
        ...
        String login_url = "http://"+ctx.getString(R.string.ip_address)+"/android_connect/viewAssignmentFragment.php";
        try {
