 ...
 */
public class LinkcourseandprofessorFragmentBackgroundTask extends AsyncTask<String,Void,String> {
    ...
    public LinkcourseandprofessorFragmentBackgroundTask(Context ctx,AsyncResponse delegate) {
        this.ctx=ctx;
